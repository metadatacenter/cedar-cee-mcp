 ...
 * Embeddable Editor (CEE), and collects human-populated instances back into the conversation. The
 * human-in-the-loop counterpart to {@code cedar-artifact-mcp} (authoring) and
